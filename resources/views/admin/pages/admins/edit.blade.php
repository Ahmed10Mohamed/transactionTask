                ...
                <div class="mb-4 col-md mb-md-0">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form class="browser-default-validation" method="post" action="{{url('admins/'.$admin->id)}}" enctype="multipart/form-data">
                              {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" value="{{$admin->name}}" required name="name" id="name"  />
                                       ...
                                       <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" value="{{$admin->user_name}}" required name="user_name" id="user_name"  />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" value="{{$admin->phone}}" required name="phone" id="phone"  />
                                       ...
                                       <div class="col-6">
                                            ...
                                            <input type="email" class="form-control" value="{{$admin->email}}" required name="email" id="email"  />
                                        ...
                                        <hr>
                                           <span  style="color: #f00">{{translate('Please Enter New Password If You Went To Change Password')}}</span>
                                        ...
                                        @foreach ($title as $key => $value)
                                            <td>
                                                ...
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" @if(permission_checker($admin->id, $key)) checked @endif name="permission[]" type="checkbox" value="{{$key}}" id="{{$key}}" />
