    ...
    <div class="authentication-inner row">
      ...
      <div class="p-0 d-none d-lg-flex col-lg-7">
        <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
          <img
            src="{{asset('backend/img/illustrations/auth-register-illustration-light.png')}}"
            alt="auth-register-cover"
            class="my-5 img-fluid auth-illustration"
            data-app-light-img="{{asset('backend/illustrations/auth-register-illustration-light.png')}}"
            data-app-dark-img="{{asset('backend/illustrations/auth-register-illustration-dark.png')}}"
          />
